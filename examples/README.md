...
`nem12-reader`. Each one runs against the bundled fixture out of the
box:
...
| [`02_daily_totals.py`](02_daily_totals.py)         | Streaming roll-up to daily kWh per channel using `nem12_reader.aggregate.daily_totals`. |
